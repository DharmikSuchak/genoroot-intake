...
1. age_hair_loss_began — a whole number between ${MIN_AGE} and ${MAX_AGE}: the patient's age when their hair loss BEGAN (not their current age, unless they imply the hair loss is happening now at their current age).
